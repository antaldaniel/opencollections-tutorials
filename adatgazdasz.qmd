...
<https://macxima.medium.com/primary-key-vs-foreign-key-in-sql-d89260b74e1c>
...
::: {.fragment .highlight-current-blue style="font-size: 80%;"}
-   ISBN: International Standard Book Numbe ([ISBN ↗](https://isbnsearch.org/){target="_blank"}) - könyvek általános azonosítására.
:::
