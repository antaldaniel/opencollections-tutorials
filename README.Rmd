...
`root` - The individual pages of [website menu](https://opencollections.net/documents/tutorials/index.html) in `qmd` files.
...
`png` - Portable Network Graphics (png files) for illustrations.
